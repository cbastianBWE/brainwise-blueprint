...
export function CoachingDisclosureModal({
  versionId,
  versionHash,
  bodyMarkdown,
  effectiveFrom,
  ...
  const handleAccept = async () => {
    setSubmitting(true);
    const { data, error } = await supabase.rpc("accept_client_coaching_disclosure" as any, {
    ...
    >
      <div className="bg-background rounded-lg shadow-xl max-w-3xl w-full my-8 flex flex-col max-h-[90vh]">
        <div className="p-6 border-b">
          <h2 className="text-xl font-semibold text-foreground">Who can see your coaching</h2>
          {effectiveFrom && (
        ...
        <div className="p-6 border-t space-y-4">
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <span className="text-sm text-foreground">
              I have read and understood this, and I understand who can read what I write
