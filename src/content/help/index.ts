...
export const helpContent: Record<HelpRoleContent["role"], HelpRoleContent> = {
  ...
  super_admin: placeholder(
    "super_admin",
    "Super Admin",
    "You administer the platform. Guides for organization setup, practitioner tracking, impersonation, trusted devices, and platform features are on the way.",
  ),
  ...
  coach_client: placeholder(
    "coach_client",
    "Practitioner Client",
    "Practitioner clients use the same flows as individual users — see the Individual tab.",
  ),
};
